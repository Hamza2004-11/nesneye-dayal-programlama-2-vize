...
public class Main {
    ...
    private static void musteriOlustur(Scanner scanner, BiletSistemi biletSistemi) {
        ...
        System.out.println("Lütfen müşteri durumunu giriniz (aktif/pasif): ");
        String durum = scanner.nextLine();

        System.out.println("Lütfen Müşteri telefon numarasını giriniz: ");
        String telefonNo = scanner.nextLine();

        System.out.println("Lütfen müşteri e-posta adresini giriniz: ");
    ...
    public static void ornekVeriEkle(BiletSistemi biletSistemi) {
        var film1 = new Film("The Hangover", "Komedi/Macera", 100, "Todd Phillips");
        var film2 = new Film("Ölümlü Dünya", " Komedi/Aksiyon ", 107, "Ali Atay");
        var film3 = new Film("Seven", "Suç/Korku", 127, "David Fincher");

        biletSistemi.filmListesineEkle(film1);
        biletSistemi.filmListesineEkle(film2);
        biletSistemi.filmListesineEkle(film3);

        var musteri1 = new Musteri("Hamza", "Aktif", "f@g.com", "05781531281");
        var musteri2 = new Musteri("Salih", "Pasif", "abc@g.com", "05893447865");

        biletSistemi.musteriListesineEkle(musteri1);
        biletSistemi.musteriListesineEkle(musteri2);

        var salon1 = new Salon("Salon 1", "Aktif", 120, "IMAX", film1);
        var salon2 = new Salon("Salon 2", "Pasif", 180, "4DX", film2);
